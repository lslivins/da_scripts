...
#nemsio2nc4.py -n sanl2_${analdate}_fhr06_ensmean
#nemsio2nc4.py -n sanl2_${analdate}_fhr06_ensmean.chgres
#nemsio2nc4.py -n sanl2_${analdate}_fhr06_ensmean.orig
#nemsio2nc4.py -n sfg_${analdate}_fhr06_ensmean
#nemsio2nc4.py -n sfg2_${analdate}_fhr06_ensmean
#nemsio2nc4.py -n sfg2_${analdate}_fhr06_ensmean.orig
