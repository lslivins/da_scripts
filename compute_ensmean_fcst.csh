...
set ncountmax=`wc -l ${datapath2}/machinesx | cut -f1 -d " "`
...
#ncks -4 -L 5 -O  ${pathout}/plevensmean.${tile}.nc ${pathout}/plevensmean.${tile}.nc
#ncks -4 -L 5 -O  ${pathout}/plevenssprd.${tile}.nc ${pathout}/plevenssprd.${tile}.nc
EOF
